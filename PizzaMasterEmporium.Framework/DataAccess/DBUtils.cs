...
namespace PizzaMasterEmporium.Framework.DataAccess
{
    public class DBUtils
    {
        ...
        public static Guid ConvertDBGuid(Object dbValue, Guid defaultValue = new Guid())
        {
            return ((dbValue == null) || (dbValue.ToString() == String.Empty)) ? defaultValue : Guid.Parse(dbValue.ToString());
        }
